  ...
  infoTeam: {
    ...
    team: {
      1: {
        name: 'Grzegorz Rutke',
        description:
          'Dziennikarz związany z takimi tytułami jak: „Gazeta Finansowa”, „Trybuna Śląska” i „Gazeta Prawna”, a następnie redaktor prowadzący w wydawnictwach Egmont Polska i Edipresse Polska. Ukończył Wydział Dziennikarstwa i Nauk Politycznych UW.',
      },
      2: {
        name: 'Jarosław Junko',
        description:
          'W dziennikarstwie od 1996 roku. Najpierw w Polskim Radiu dla Zagranicy, a następnie, od 2005 roku, jako korespondent Polskiej Agencji Prasowej na Ukrainie. Relacjonował m.in. wydarzenia Pomarańczowej Rewolucji 2004 roku, wojnę w Gruzji w 2008 roku oraz Rewolucję Godności z przełomu lat 2013-2014.',
      },
      3: {
        name: 'Monika Wysocka',
        description:
